...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("pkce")
        description.set("Kotlin multiplatform PKCE implementation.")
        ...
        issueManagement {
            url.set("https://github.com/mooncloak/pkce/issues")
        ...
        developers {
            developer {
                ...
                roles.set(setOf("Primary pkce developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/pkce.git")
            developerConnection.set("https://github.com/mooncloak/pkce.git")
            url.set("https://github.com/mooncloak/pkce")
        }
    }
}
